...
import { ADB_SETTINGS_LOAD, ADB_SETTINGS_WRITE, ADB_STATUS, ADD_HISTORY, DEVICE_CHANGE, LOAD_CONSOLE_SETTINGS, LOAD_HISTORY, LOAD_TOKEN, TAB_ADD, TAB_DEL, WRITE_CONSOLE_SETTINGS, WRITE_TOKEN } from './actionTypes';
...
export const loadHistory = (content: string[]) => ({
  type: LOAD_HISTORY,
  payload: content
});
