import { Action } from ".";
import { ADB_SETTINGS_LOAD, ADB_SETTINGS_WRITE, LOAD_CONSOLE_SETTINGS, LOAD_TOKEN, WRITE_CONSOLE_SETTINGS, WRITE_TOKEN } from "../actionTypes";
...
export default function (state = initialState, action: Action) {
  switch (action.type) {
    ...
    case WRITE_CONSOLE_SETTINGS: {
      ...
      if (lines < 1 || lines > 2000) lines = 500;
